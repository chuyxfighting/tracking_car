...
void	   DMA2_Stream5_IRQHandler()			 {  Gec_IntHandler(100); } // DMA2 Stream 5								   
void	   DMA2_Stream6_IRQHandler()			 {  Gec_IntHandler(100); } // DMA2 Stream 6								   
void	   DMA2_Stream7_IRQHandler()			 {  Gec_IntHandler(100); } // DMA2 Stream 7								   
void	   USART6_IRQHandler()				 {  Gec_IntHandler(100); } // USART6											
void	   I2C3_EV_IRQHandler()				 {  Gec_IntHandler(100); } // I2C3 event											  
void	   I2C3_ER_IRQHandler()				 {  Gec_IntHandler(100); } // I2C3 error											  
void	   OTG_HS_EP1_OUT_IRQHandler()		 {  Gec_IntHandler(100); } // USB OTG HS End Point 1 Out					   
void	   OTG_HS_EP1_IN_IRQHandler() 		 {  Gec_IntHandler(100); } // USB OTG HS End Point 1 In					   
void	   OTG_HS_WKUP_IRQHandler()			 {  Gec_IntHandler(100); } // USB OTG HS Wakeup through EXTI						  
void	   OTG_HS_IRQHandler()				 {  Gec_IntHandler(100); } // USB OTG HS									   
void	   DCMI_IRQHandler()					 {  Gec_IntHandler(100); } // DCMI 										   
void	   CRYP_IRQHandler()					 {  Gec_IntHandler(100); } // CRYP crypto									   
void	   HASH_RNG_IRQHandler()				 {  Gec_IntHandler(100); } // Hash and Rng
void	   FPU_IRQHandler()					 {  Gec_IntHandler(100); } // FPU
